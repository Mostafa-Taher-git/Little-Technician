    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Task Manager shows 100% CPU usage, system is slow',
          cause: 'A background process or malware consuming CPU resources',
        ...
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'PC shuts down randomly, fan runs at full speed, thermal warnings',
          cause: 'Dust buildup or dried thermal paste preventing heat transfer',
        ...
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'No power, no lights, no fans when pressing power button',
          cause: 'Power supply issue or disconnected cable',
        ...
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'Motherboard beeps in a pattern on startup, no display',
          cause: 'POST error code indicating hardware issue',
        ...
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'System shows less RAM than installed, or beeps on boot',
          cause: 'RAM stick not properly seated or incompatible module',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
      ],
    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'Powers on but no Windows loads, stuck at BIOS or black screen',
          cause: 'Corrupted boot files or incorrect boot order',
          estimatedTime: '10-20 minutes',
          difficulty: DifficultyLevel.medium,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'PC keeps restarting before reaching the desktop',
          cause: 'Faulty driver, update, or system file corruption',
          estimatedTime: '15-30 minutes',
          difficulty: DifficultyLevel.medium,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'Blue screen with error code, system crashes',
          cause: 'Driver conflict, hardware failure, or corrupted system files',
          estimatedTime: '10-20 minutes',
          difficulty: DifficultyLevel.medium,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Windows takes forever to open programs, lags constantly',
          cause: 'Too many startup programs, fragmentation, or malware',
          estimatedTime: '10-20 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Speakers or headphones produce no audio at all',
          cause: 'Wrong output device selected, muted, or driver issue',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
      ],
    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Cursor frozen, mouse not moving at all',
          cause: 'Faulty USB port, dead battery, or driver issue',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Mouse movement is delayed and stuttering',
          cause: 'High resource usage, dirty sensor, or wireless interference',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Keys do not register when pressed',
          cause: 'Loose connection, driver issue, or debris under keys',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'Printer',
          symptoms: 'Printer shows as offline in Windows',
          cause: 'Loose connection, stopped print spooler, or driver issue',
        ...
        LevelDef(
          ...
          points: 100,
          deviceType: 'Printer',
          symptoms: 'Paper stuck inside printer, error light on',
          cause: 'Overloaded tray, damp paper, or debris inside',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
      ],
    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          cause: 'Missing dependencies, corrupted files, or compatibility issue',
          estimatedTime: '5-15 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'Router',
          symptoms: 'Can\'t access websites, browser shows "no connection"',
          cause: 'Router needs restart, cable loose, or ISP outage',
          estimatedTime: '5-15 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Router',
          symptoms: 'Web pages load very slowly, videos buffer constantly',
          cause: 'Bandwidth congestion, Wi-Fi interference, or ISP issue',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Router',
          symptoms: 'Some sites don\'t load but internet seems connected',
          cause: 'DNS server issue or corrupted DNS cache',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'VPN client fails to establish connection',
          cause: 'Firewall blocking, wrong protocol, or server issue',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
      ],
    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'Drive doesn\'t appear in File Explorer or Disk Management',
          cause: 'Loose cable, uninitialized drive, or failing hardware',
          estimatedTime: '10-15 minutes',
          difficulty: DifficultyLevel.medium,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Can\'t save files, "disk full" error messages',
          cause: 'Temporary files, large downloads, or old backups filling the drive',
          estimatedTime: '5-15 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'Monitor shows black screen but PC is powered on',
          cause: 'Loose video cable, wrong input, or GPU issue',
          estimatedTime: '5-15 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Monitor display flickers intermittently',
          cause: 'Bad cable, outdated driver, or wrong refresh rate',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Black or stuck colored pixels on screen',
          cause: 'Manufacturing defect or pressure damage to panel',
    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          points: 100,
          deviceType: 'Phone',
          symptoms: 'Phone battery dies within hours of full charge',
          cause: 'Screen brightness, background apps, or location services draining power',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Phone',
          symptoms: 'Device gets uncomfortably hot during normal use',
          cause: 'Direct sunlight, intensive apps, or faulty battery',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Phone',
          symptoms: 'Apps close unexpectedly with error messages',
          cause: 'Outdated app, corrupted cache, or insufficient memory',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'Phone',
          symptoms: 'No charging indicator when cable is plugged in',
          cause: 'Dirty port, damaged cable, or faulty charger',
          estimatedTime: '5-15 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Phone',
          symptoms: 'Phone is sluggish, apps take forever to open',
          cause: 'Low storage, too many background apps, or old software',
          estimatedTime: '5-15 minutes',
          difficulty: DifficultyLevel.easy,
        ),
      ],
    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Game closes immediately after launching',
          cause: 'Corrupted files, outdated drivers, or overlay conflict',
          estimatedTime: '10-15 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'Unplayably low frame rates, choppy gameplay',
          cause: 'High graphics settings, background apps, or thermal throttling',
          estimatedTime: '10-20 minutes',
          difficulty: DifficultyLevel.medium,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Console',
          symptoms: 'Wireless controller won\'t pair or connect',
          cause: 'Low battery, Bluetooth issue, or firmware bug',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'PC',
          symptoms: 'Audio cuts out or stutters during gameplay',
          cause: 'Audio driver conflict or hardware acceleration issue',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'PC',
          symptoms: 'Driver stops responding, screen goes black during game',
          cause: 'Unstable overclock, overheating, or corrupt driver',
          estimatedTime: '15-30 minutes',
    ...
    WorldDef(
      ...
      levels: [
        LevelDef(
          ...
          symptoms: 'Device shows as offline in companion app',
          cause: 'Wi-Fi disconnect, power issue, or firmware bug',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Smart Home',
          symptoms: 'Smart speaker doesn\'t respond to wake word',
          cause: 'Microphone muted, Wi-Fi down, or firmware issue',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Smart Home',
          symptoms: 'Bulb won\'t pair with hub or app',
          cause: 'Wrong Wi-Fi band, unreset bulb, or hub firmware outdated',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
        LevelDef(
          ...
          points: 150,
          deviceType: 'Smart Home',
          symptoms: 'Hub gets stuck during initial setup',
          cause: 'Network mismatch, unstable connection, or firmware issue',
          estimatedTime: '10-20 minutes',
          difficulty: DifficultyLevel.medium,
        ),
        LevelDef(
          ...
          points: 100,
          deviceType: 'Smart Home',
          symptoms: 'Routines don\'t execute automatically',
          cause: 'Wrong conditions, device offline, or time zone mismatch',
          estimatedTime: '5-10 minutes',
          difficulty: DifficultyLevel.easy,
        ),
      ],
