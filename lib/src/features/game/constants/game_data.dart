      ...
      levels: [
        LevelDef(
          ...
          steps: [
            ...
            'Enable battery saver mode to extend daily usage.',
          ],
          points: 100,
        ),
        LevelDef(
          ...
          steps: [
            ...
            'Avoid using the phone while charging to reduce heat buildup.',
          ],
          points: 100,
        ),
        LevelDef(
          ...
          steps: [
            ...
            'Check for OS updates that may fix app compatibility issues.',
          ],
          points: 100,
        ),
        LevelDef(
        ...
        LevelDef(
          ...
          steps: [
            ...
            'Factory reset as a last resort if performance doesn\'t improve.',
          ],
          points: 100,
        ),
      ],
      ...
      levels: [
        LevelDef(
          ...
          steps: [
            ...
            'Check for Windows updates that may resolve compatibility issues.',
          ],
          points: 100,
        ),
        LevelDef(
        ...
        LevelDef(
          ...
          steps: [
            ...
            'Update controller firmware via the manufacturer\'s companion app.',
          ],
          points: 100,
        ),
        LevelDef(
          ...
          steps: [
            ...
            'Set the game\'s audio quality to Low or Medium in its settings menu.',
          ],
          points: 100,
        ),
        LevelDef(
      ...
      levels: [
        LevelDef(
          ...
          steps: [
            ...
            'Check if the device firmware needs an update via its companion app.',
          ],
          points: 100,
        ),
        LevelDef(
          ...
          steps: [
            ...
            'Factory reset the speaker if no update resolves the issue.',
          ],
          points: 100,
        ),
        LevelDef(
          ...
          steps: [
            ...
            'Ensure your phone\'s Bluetooth is enabled for initial pairing.',
          ],
          points: 100,
        ),
        LevelDef(
        ...
        LevelDef(
          ...
          steps: [
            ...
            'Check if the hub\'s time zone and location settings are correct.',
          ],
          points: 100,
        ),
      ],
